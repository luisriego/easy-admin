...
class getProfileControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.kvgAejm'] ?? $container->load('get_ServiceLocator_KvgAejmService'))->withContext('App\\Controller\\ProfileController', $container));
