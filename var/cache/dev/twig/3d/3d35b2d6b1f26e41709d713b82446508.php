...
class __TwigTemplate_678a2c67b47fc0dd25b261dd44d60db0 extends Template
{
    private $source;
    private $macros = [];
...
if (typeof Sfjs === 'undefined' || typeof Sfjs.loadToolbar === 'undefined') {
    Sfjs = (function() {
        ...
        var extractHeaders = function(xhr, stackElement) {
            ...
            if (ret = allHeaders.match(/^easy-admin-Debug-Toolbar-Replace:\\s+(.*)\$/im)) {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            echo "))) {
                        ...
                        promise.then(function (r) {
                            ...
                            stackElement.toolbarReplaceFinished = false;
                            stackElement.toolbarReplace = '1' === r.headers.get('easy-admin-Debug-Toolbar-Replace');
