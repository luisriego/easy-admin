...
use easy-admin\Component\Config\Resource\ClassExistenceResource;
use easy-admin\Component\Config\Resource\ComposerResource;
...
use easy-admin\Component\Config\Resource\GlobResource;
use easy-admin\Component\Config\Resource\ReflectionClassResource;
use easy-admin\Component\Config\Resource\ResourceInterface;
use easy-admin\Component\DependencyInjection\Argument\AbstractArgument;
use easy-admin\Component\DependencyInjection\Argument\IteratorArgument;
use easy-admin\Component\DependencyInjection\Argument\RewindableGenerator;
use easy-admin\Component\DependencyInjection\Argument\ServiceClosureArgument;
use easy-admin\Component\DependencyInjection\Argument\ServiceLocator;
use easy-admin\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use easy-admin\Component\DependencyInjection\Attribute\Target;
use easy-admin\Component\DependencyInjection\Compiler\Compiler;
use easy-admin\Component\DependencyInjection\Compiler\CompilerPassInterface;
use easy-admin\Component\DependencyInjection\Compiler\PassConfig;
use easy-admin\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use easy-admin\Component\DependencyInjection\Exception\BadMethodCallException;
use easy-admin\Component\DependencyInjection\Exception\InvalidArgumentException;
use easy-admin\Component\DependencyInjection\Exception\LogicException;
use easy-admin\Component\DependencyInjection\Exception\RuntimeException;
use easy-admin\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use easy-admin\Component\DependencyInjection\Exception\ServiceNotFoundException;
use easy-admin\Component\DependencyInjection\Extension\ExtensionInterface;
use easy-admin\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use easy-admin\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use easy-admin\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use easy-admin\Component\DependencyInjection\ParameterBag\ParameterBag;
use easy-admin\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
use easy-admin\Component\ExpressionLanguage\Expression;
use easy-admin\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    final public static function willBeAvailable(string $package, string $class, array $parentPackages): bool
    {
        ...
        if ('easy-admin/easy-admin' === $rootPackage) {
            return true;
        }
    ...
    private function getExpressionLanguage(): ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!class_exists(\easy-admin\Component\ExpressionLanguage\ExpressionLanguage::class)) {
                throw new LogicException('Unable to use expressions as the easy-admin ExpressionLanguage component is not installed.');
            }
