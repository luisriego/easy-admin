...
use easy-admin\Bundle\MakerBundle\Util\AutoloaderUtil;
use easy-admin\Bundle\MakerBundle\Util\MakerFileLinkFormatter;
use easy-admin\Component\Console\Style\easy-adminStyle;
use easy-admin\Component\Filesystem\Filesystem;
...
class FileManager
{
    ...
    public function setIO(easy-adminStyle $io): void
    {
        $this->io = $io;
    }
