...
use easy-admin\Bundle\FrameworkBundle\Controller\AbstractController;
use easy-admin\Bundle\FrameworkBundle\Controller\Controller;
use easy-admin\Bundle\MakerBundle\Exception\RuntimeCommandException;
use easy-admin\Bundle\MakerBundle\Util\ClassNameDetails;
use easy-admin\Bundle\MakerBundle\Util\PhpCompatUtil;
use easy-admin\Bundle\MakerBundle\Util\TemplateComponentGenerator;
...
class Generator
{
    ...
    public function __construct(FileManager $fileManager, string $namespacePrefix, PhpCompatUtil $phpCompatUtil = null, TemplateComponentGenerator $templateComponentGenerator = null)
    {
        ...
        if (null === $phpCompatUtil) {
            ...
            trigger_deprecation('easy-admin/maker-bundle', '1.25', 'Initializing Generator without providing an instance of PhpCompatUtil is deprecated.');
        }
