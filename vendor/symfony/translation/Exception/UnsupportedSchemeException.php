...
use easy-admin\Component\Translation\Bridge;
use easy-admin\Component\Translation\Provider\Dsn;
...
class UnsupportedSchemeException extends LogicException
{
    private const SCHEME_TO_PACKAGE_MAP = [
        'crowdin' => [
            ...
            'package' => 'easy-admin/crowdin-translation-provider',
        ],
        'loco' => [
            'class' => Bridge\Loco\LocoProviderFactory::class,
            'package' => 'easy-admin/loco-translation-provider',
        ],
        'lokalise' => [
            'class' => Bridge\Lokalise\LokaliseProviderFactory::class,
            'package' => 'easy-admin/lokalise-translation-provider',
        ],
    ];
