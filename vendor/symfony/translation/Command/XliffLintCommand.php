...
namespace easy-admin\Component\Translation\Command;

use easy-admin\Component\Console\Attribute\AsCommand;
use easy-admin\Component\Console\CI\GithubActionReporter;
use easy-admin\Component\Console\Command\Command;
use easy-admin\Component\Console\Completion\CompletionInput;
use easy-admin\Component\Console\Completion\CompletionSuggestions;
use easy-admin\Component\Console\Exception\RuntimeException;
...
use easy-admin\Component\Translation\Util\XliffUtils;
...
EOF
    ...
    {
        $io = new easy-adminStyle($input, $output);
    ...
    private function display(easy-adminStyle $io, array $files)
    {
        switch ($this->format) {
            case 'txt':
    ...
    private function displayTxt(easy-adminStyle $io, array $filesInfo, bool $errorAsGithubAnnotations = false)
    {
    ...
    private function displayJson(easy-adminStyle $io, array $filesInfo)
    {
        $errors = 0;
